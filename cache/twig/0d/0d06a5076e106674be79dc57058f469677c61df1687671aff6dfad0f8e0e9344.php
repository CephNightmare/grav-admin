...
class __TwigTemplate_d64fed32a33b466e8e74e5176729f8ae34e2e646a93dc10742f22feba6eea79a extends Twig_Template
{
        ...
        try {
            ...
            foreach ($context['_seq'] as $context["index"] => $context["field"]) {
                ...
                if (((null === (isset($context["input"]) ? $context["input"] : null)) || ((isset($context["input"]) ? $context["input"] : null) == true))) {
                    ...
                    echo ": ";
                    echo ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->stringFunc(((twig_test_iterable((isset($context["value"]) ? $context["value"] : null))) ? (twig_jsonencode_filter((isset($context["value"]) ? $context["value"] : null))) : ((isset($context["value"]) ? $context["value"] : null)))) . "
");
                } else {
                    // line 8
...
{%- endautoescape %}", "forms/default/data.txt.twig", "F:\\wamp64\\www\\grav-admin\\user\\plugins\\form\\templates\\forms\\default\\data.txt.twig");
    }
}
